...
func TestGetOpenPositions(t *testing.T) {
	...
	post1 := createMockPost(t, ctx, c, com1Res.Id, "Grab", "Post 1", lex, "1 month", "Apply via email",
		[]string{"Software Engineer", "Data Scientist"}, []string{"Golang", "Python"}, []string{"Free lunch", "Free dinner"})
	post2 := createMockPost(t, ctx, c, com2Res.Id, "Agoda", "Post 2", lex, "2 month", "Apply via phone",
		[]string{"Data Analysts", "Full-Stack Developer"}, []string{"Python", "HTML", "CSS"}, []string{"Free lunch", "Macbook Pro"})
	post3 := createMockPost(t, ctx, c, com2Res.Id, "Agoda", "Post 3", lex, "3 month", "Apply via email",
		[]string{"Backend Developer", "Data Scientist"}, []string{"Golang", "Python"}, []string{"Free dinner", "Macbook M1"})
	post4 := createMockPost(t, ctx, c, com2Res.Id, "Agoda", "Post 4", lex, "4 month", "Apply via email",
		[]string{"Frontend Developer", "Data Analyst"}, []string{"HTML", "CSS", "Javascript"}, []string{"Free lunch", "Free dinner", "Macbook M1"})
	post5 := createMockPost(t, ctx, c, com3Res.Id, "Lineman", "Post 5", lex, "5 month", "Apply via Facebook",
...
func TestGetRequiredSkills(t *testing.T) {
	...
	post1 := createMockPost(t, ctx, c, com1Res.Id, "Grab", "Post 1", lex, "1 month", "Apply via email",
		[]string{"Software Engineer", "Data Scientist"}, []string{"Golang", "Python"}, []string{"Free lunch", "Free dinner"})
	post2 := createMockPost(t, ctx, c, com2Res.Id, "KBTG", "Post 2", lex, "2 month", "Apply via email",
		[]string{"Data Analysts", "Full-Stack Developer"}, []string{"Python", "HTML", "CSS"}, []string{"Free lunch", "Macbook Pro"})
	post3 := createMockPost(t, ctx, c, com2Res.Id, "KBTG", "Post 3", lex, "3 month", "Apply via email",
		[]string{"Backend Developer", "Data Scientist"}, []string{"Golang", "Python"}, []string{"Free dinner", "Macbook M1"})
	post4 := createMockPost(t, ctx, c, com2Res.Id, "KBTG", "Post 4", lex, "4 month", "Apply via email",
		[]string{"Frontend Developer", "Data Analyst"}, []string{"HTML", "CSS", "Javascript"}, []string{"Free lunch", "Free dinner", "Macbook M1"})
	post5 := createMockPost(t, ctx, c, com3Res.Id, "SCB", "Post 5", lex, "5 month", "Apply via email",
		[]string{"Frontend Developer", "Data Analyst"}, []string{"HTML", "CSS", "Javascript"}, []string{"Free lunch", "Free dinner", "Macbook Pro"})
...
func TestGetBenefits(t *testing.T) {
	...
	post1 := createMockPost(t, ctx, c, com1Res.Id, "TTB", "Post 1", lex, "1 month", "Apply via Phone",
		[]string{"Software Engineer", "Data Scientist"}, []string{"Golang", "Python"}, []string{"Free lunch", "Free dinner"})
	post2 := createMockPost(t, ctx, c, com2Res.Id, "Wongnai", "Post 2", lex, "2 month", "Apply via Phone",
		[]string{"Data Analysts", "Full-Stack Developer"}, []string{"Python", "HTML", "CSS"}, []string{"Free lunch", "Macbook Pro"})
	post3 := createMockPost(t, ctx, c, com2Res.Id, "Wongnai", "Post 3", lex, "3 month", "Apply via Phone",
		[]string{"Backend Developer", "Data Scientist"}, []string{"Golang", "Python"}, []string{"Free dinner", "Macbook M1"})
	post4 := createMockPost(t, ctx, c, com2Res.Id, "Wongnai", "Post 4", lex, "4 month", "Apply via Phone",
		[]string{"Frontend Developer", "Data Analyst"}, []string{"HTML", "CSS", "Javascript"}, []string{"Free lunch", "Free dinner", "Macbook M1"})
	post5 := createMockPost(t, ctx, c, com3Res.Id, "KBTG", "Post 5", lex, "5 month", "Apply via Phone",
		[]string{"Frontend Developer", "Data Analyst"}, []string{"HTML", "CSS", "Javascript"}, []string{"Free lunch", "Free dinner", "Macbook Pro"})
